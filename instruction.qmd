...
**Important note:** If you run into problems, send a direct message to us on the course Slack channel with a detailed description of the problem you've encountered.

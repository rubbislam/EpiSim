...
- To learn more, see the panelPomp research paper (to appear in the R Journal) [@panelPomp].
...
set.seed(1234)
phylopomp::simulate("SEIR",Beta=2,sigma=2,gamma=1,psi=2,S0=1000,I0=5,time=2) |>
  phylopomp::simulate(Beta=5,gamma=2,time=5,psi=3) -> model.seir
plot(model.seir)
```
:::
:::::
...
phylopomp::simulate("SIR",time=10,Beta=3,gamma=1,psi=2,omega=1,S0=100,I0=5) -> x
# build a pomp object
x |>
  sir_pomp(

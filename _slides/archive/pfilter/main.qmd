...
-   The **one-step transition density**,
    $f_{X_n|X_{n-1}}(x_n|x_{n-1};\theta)$, together with the **measurement density**,
    $f_{Y_n|X_n}(y_n|x_n;\theta)$ and the **initial density**,
...
\begin{center}
    \includegraphics[height=7cm]{../graphics/directsim_graph.pdf}
\end{center}
...
\begin{center}
    \includegraphics[height=6cm]{../graphics/pfilter_graph.pdf}
\end{center}
...
-   It can be shown that the particle filter provides an unbiased
    estimate of the likelihood (@Kitagawa1987,

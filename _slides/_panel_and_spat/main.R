...
## ----phylopomp-exercise-1-1, eval=FALSE----------------------------------------------------------------
# library(phylopomp)
...
## ----phylopomp-exercise-1-2, eval=FALSE----------------------------------------------------------------
...
## ----phylopomp-exercise-2-1, eval=FALSE----------------------------------------------------------------
# library(pomp)
# simulate("SEIRS",
#   Beta=4,sigma=1,gamma=1,psi=1,omega=1,
#   S0=100,E0=3,I0=5,R0=100, time=5
...
## ----phylopomp-exercise-2-2, eval=FALSE----------------------------------------------------------------
# simulate(
#   "SIR",time=10,

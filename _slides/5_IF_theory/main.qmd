...
The following codes (also see `/scripts/exercise_mif_*.R` for your OS) run ONE iterated filtering with 50 iterations and show how parameters change over iteration.

...
1.  \label{#A13a}
  The measurement times, `time(po)`, should be in units of weeks, such as $1,2,\dots,104$.
...
3.  \label{#A13c} The measurement times do not have to be in units of weeks.
...
## solution
  ...
  A complete reference guide to R's C interface \underline{[can be found here](https://cran.r-project.org/doc/manuals/r-release/R-exts.html\#The-R-API)}.
  In particular, the C form of R's distribution functions is \underline{[fully described here](https://cran.r-project.org/doc/manuals/r-release/R-exts.html\#Distribution-functions)}.

...
```{=tex}
\begin{center}
  \includegraphics[height=9cm]{../graphics/mcmc-robot2.png}
\end{center}
```
## MCMC Robot Rules (actual)
...
```{=tex}
\begin{center}
  \includegraphics[height=9cm]{../graphics/mcmc-robot3.png}
\end{center}
```
## MCMC Robot Rules (actual)
...
```{=tex}
\begin{center}
  \includegraphics[height=9cm]{../graphics/mcmc-robot4.png}
\end{center}
```
...
```{=tex}
\begin{center}
  \includegraphics[height=8cm]{../graphics/mcmc-demo1.png}
\end{center}
```
## MCMC Demonstration (https://plewis.github.io/applets/mcmc-robot/)
...
```{=tex}
\begin{center}
  \includegraphics[height=8cm]{../graphics/mcmc-demo2.png}
\end{center}
```
## MCMC Demonstration (https://plewis.github.io/applets/mcmc-robot/)
...
```{=tex}
\begin{center}
  \includegraphics[height=8cm]{../graphics/mcmc-demo3.png}
\end{center}
```
## MCMC Demonstration (https://plewis.github.io/applets/mcmc-robot/)
...
```{=tex}
\begin{center}
  \includegraphics[height=8cm]{../graphics/mcmc-demo4.png}
\end{center}
```
## MCMC Demonstration (https://plewis.github.io/applets/mcmc-robot/)
...
```{=tex}
\begin{center}
  \includegraphics[height=8cm]{../graphics/mcmc-demo5.png}
\end{center}
```
